...
agregarDato(69,vec1,tam)
imprimeVector(vec1,"vector vec1 despues de agregar dato:\t")
...
insertarDato(69,2,vec2,tam)
imprimeVector(vec2,"vector vec2 despues de insertar un dato:\t")
ordenaAscendente(vec2)
imprimeVector(vec2,"vector vec2 despues de ordenarlo:\t")
